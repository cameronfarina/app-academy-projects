...
def cats_and_toys_alike
  # Find all the cat names where the cat and 
  # the toy they own are both the color 'Blue'.
...
def toyless_blue_cats
  # Use a type of JOIN that will list the names of all the 
  # cats that are 'Navy Blue' and have no toys. 
