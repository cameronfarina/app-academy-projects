...
def all_vowel_pairs(words)
    ...
    words.each_with_index do |word_1, i_1|
        words.each_with_index do |word_2, i_2|
            pairs = word_1 + " " + word_2
            all_vowels_in_pairs << pairs if i_2 > i_1 && vowels.all? { |vowel| pairs.include?(vowel) }
        end
    end
    all_vowels_in_pairs
end
...
class String
    ...
    def substrings(length = nil)
        ...
        if length.nil?
            ...
            return subs.select { |str| str.length == length }
        end
    end
    ...
    def caesar_cipher(num)
        ...
        self.each_char do |char|
            ...
            end_pos = (start_pos + num) % 26
            new_str += alphabet[end_pos]
        end
        new_str 
    end
end
